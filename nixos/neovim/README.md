...
| CSS        | prettierd    |                                    |                 | default           |
| HTML       | prettierd    |                                    |                 | default           |
| Javascript | prettierd     |                                    |                 | javascript        |
| Typescript | prettierd     |                                    |                 | javascript        |
| JSON       | prettierd     | jsonls                             |                 | default           |
| Markdown   | prettierd     | marksman                           |                 | default           |
...
| Node       | prettierd     | tsserver                           | vscode-js-debug | javascript        |
